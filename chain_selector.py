...
_EXPIRIES_TRACKED = 8     # Consecutive maturities to build a dense term structure
_OTM_PUTS_PER_EXPIRY = 10    # Contiguous OTM puts for the left wing and skew
_OTM_CALLS_PER_EXPIRY = 10  # Contiguous OTM calls for the right wing
